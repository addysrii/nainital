        ...
        >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className={`transform transition-all duration-1000 ${isVisible[`section-${index}`] ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
                }`}>
                {/* Content Card */}
        ...
        <div className="fixed right-4 sm:right-8 top-1/2 transform -translate-y-1/2 z-50 space-y-3 sm:space-y-4">
          {storyData.map((_, index) => (
            <button
              ...
              className={`block w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full transition-all duration-300 ${isVisible[`section-${index}`]
