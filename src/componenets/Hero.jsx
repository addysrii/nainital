    ...
    <div className="min-h-screen text-white overflow-x-hidden">
      ...
      <div className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
          ...
          <button 
            ...
            className="group bg-white/20 backdrop-blur-md border border-white/30 hover:bg-white/30 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl"
          >
            Begin the Story
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className={`transform transition-all duration-1000 ${
                ...
                {/* Content Card */}
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 shadow-2xl">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
                    ...
                    <div className={`${index % 2 === 0 ? 'lg:order-2' : 'lg:order-1'} order-2`}>
                      <div className="space-y-4 sm:space-y-6">
                        <div className="backdrop-blur-sm bg-white/5 p-4 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl border border-white/10 shadow-lg">
      ...
      <div className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          {/* Story Navigation */}
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-white/20 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
              {storyData.slice(0, 4).map((story, index) => (
                <button
                  key={index}
                  onClick={() => scrollToSection(index)}
                  className="group bg-white/10 hover:bg-white/20 backdrop-blur-lg rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/20 transition-all duration-300 hover:scale-105"
                >
