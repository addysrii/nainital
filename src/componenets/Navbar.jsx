...
const PROJECTS = [
  {
    ...
    category: 'Web & Mobile',
    year: '2024',
    description: 'A hyperlocal social newtworking platform for the proffesionals',
  ...
  //   category: 'Mobile',
  //   year: '2024',
  //   description: 'Matchmaking platform that pairs users by horoscope compatibility with real-time chat and swipe UX.',
  //   tech: ['React Native', 'FastAPI', 'Python', 'WebSockets', 'PostgreSQL'],
  ...
  // },
  // {
  //   title: 'QR Society App',
  //   subtitle: 'React Native Port',
  //   category: 'Mobile',
  //   year: '2024',
  //   description: 'Full mobile port of the Society QR system with biometric login, offline sync, and role-based screens.',
  //   tech: ['React Native', 'Expo', 'JWT', 'SQLite', 'Keychain'],
