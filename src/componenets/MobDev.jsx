...
const PROJECTS = [
  {
    ...
    year: '2024',
    description: "Smarter Connections, Seamless Networking Concept Overview: MeetKats is a smart networking and crowd management platform designed to eliminate the chaos of traditional event experiences.",
  ...
  },
  {
    ...
    year: '2026',
    description: 'Horoscope-based matchmaking dating app with a custom onboarding workflow, real-time messaging, compatibility scoring, and swiping UX.',
